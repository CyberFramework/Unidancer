...
function render() {
    document.getElementById("Background1").onclick = function(){axis = xAxis; render(); };
    document.getElementById("Background2").onclick = function(){axis = yAxis; render(); };
    document.getElementById("Background3").onclick = function(){axis = zAxis; render(); };
    document.getElementById("Model1").onclick = function(){axis = xAxis; render(); };
    document.getElementById("Model2").onclick = function(){axis = yAxis; render(); };
    document.getElementById("Model3").onclick = function(){axis = zAxis; render(); };
